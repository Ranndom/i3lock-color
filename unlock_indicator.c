...
#ifndef NOLIBCAIRO
/* How the image should be rendererd */
...
void prerender_background_images(cairo_surface_t* bgimg) {
    ...
    for (int i = 0; i < num_imgs; i++) {
        ...
        /* draw solid colour -- theoretically this could be optimized away in case drawmode is either DRAWMODE_TILE OR DRAWMODE_ZOOM */
